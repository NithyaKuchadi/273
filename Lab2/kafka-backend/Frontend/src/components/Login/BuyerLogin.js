...
import { loginBuyer } from '../../actions/signup_login_actions';
...
await this.props.loginBuyer(post);
if (this.props.BuyerloginSuccess) {
...
const mapDispatchToProps = dispatch => {
    return {
        loginBuyer: post => {
            dispatch(loginBuyer(post));
        }
    };
};
const mapStateToProps = (state) => {
    return {
       BuyerloginSuccess: state.signin.loginSuccess
