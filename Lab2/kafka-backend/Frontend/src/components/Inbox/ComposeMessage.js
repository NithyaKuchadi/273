...
import { getEmailList , postMessage } from '../../actions/inbox_actions';
...
class ComposeMessage extends Component {
    ...
    render() {
        var fromEmail = null;
        fromEmail = localStorage.getItem('cookie3');
                        ...
                        <div className="modal-body">
                            <form onSubmit={this.saveMessage} method="post">
                                ...
                                <div className="form-group row">
                                    ...
                                    <div className="col-sm-7">
                                    <input type="email" className="form-control" name="to"  required />
                                    </div>
                                </div>
                                <div className="form-group row">
