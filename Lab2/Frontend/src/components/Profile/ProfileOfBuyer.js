...
import {profileDetailsofBuyer, pastOrdersofBuyer, upcomingOrdersofBuyer} from '../../actions/profile_actions';
...
const mapStateToProps = (state) => {
  ...
  export default connect(
    mapStateToProps,
    { profileDetailsofBuyer,pastOrdersofBuyer, upcomingOrdersofBuyer,imageDownload}
  )(ProfileOfBuyer);
