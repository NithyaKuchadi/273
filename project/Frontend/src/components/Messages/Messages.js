...
import { getInboxMessages } from '../../actions/message_actions';
                        ...
                        <div className="row">
                            ...
                            <div className="col-sm-4">
                                ...
                                <ul>
                                    ...
                                    <li onClick={InboxClick} className="li-id"><Link to="/Message">Inbox</Link></li>
                                    <li onClick={SentMsgsClick} className="li-id"><Link to="/Message">Sent</Link></li>
                                </ul>
                            </div>
                            <div className="col-sm-4">
